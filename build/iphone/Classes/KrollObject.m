 ...
 * Copyright (c) 2009-2011 by MoHeWo, Inc. All Rights Reserved.
...
//@interface MoHeWoObject : NSObject
//@end

@interface MoHeWoObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[MoHeWoObject class]])
		{
			for (NSString *key in [[(MoHeWoObject*)o modules] allKeys])
			{
