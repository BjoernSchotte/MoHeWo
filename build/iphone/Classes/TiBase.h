...
// in simulator we redefine to format for MoHeWo Developer console
...
{\
	NSString * exceptionName = [@"org.mohewo." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.mohewo";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIMoHeWoNativeItemNone = -1, 
	UIMoHeWoNativeItemSpinner = -2,
	UIMoHeWoNativeItemProgressBar = -3,
	
	UIMoHeWoNativeItemSlider = -4,
	UIMoHeWoNativeItemSwitch = -5,
	UIMoHeWoNativeItemMultiButton = -6,
	UIMoHeWoNativeItemSegmented = -7,
	
	UIMoHeWoNativeItemTextView = -8,
	UIMoHeWoNativeItemTextField = -9,
	UIMoHeWoNativeItemSearchBar = -10,
	
	UIMoHeWoNativeItemPicker = -11,
	UIMoHeWoNativeItemDatePicker = -12,
	
	UIMoHeWoNativeItemInfoLight = -13,
	UIMoHeWoNativeItemInfoDark = -14,
	
	UIMoHeWoNativeItemDisclosure = -15,
	
	UIMoHeWoNativeItemContactAdd = -16
};
